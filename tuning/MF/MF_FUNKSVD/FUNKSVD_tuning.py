...
from src.Recommenders.MatrixFactorization.Cython.MatrixFactorization_Cython import MatrixFactorization_FunkSVD_Cython
...
ICM_combined = combine_matrices(ICM=ICM, URM=URM_train)
...
recommender_input_args = SearchInputRecommenderArgs(
    CONSTRUCTOR_POSITIONAL_ARGS = [ICM_combined],
...
tuning_class = SearchBayesianSkopt(recommender_class=MatrixFactorization_FunkSVD_Cython,
...
tuning_class.search(recommender_input_args=recommender_input_args,
                    ...
                    output_file_name_root=MatrixFactorization_FunkSVD_Cython.RECOMMENDER_NAME,
                    save_model="best"
                    )
