## Best config is 65: {'topK': 450, 'shrink': 5.0, 'similarity': 'tanimoto'}
...
tuning_class = SearchBayesianSkopt(recommender_class=UserKNNCFRecommender,
...
tuning_class.search(recommender_input_args=recommender_input_args,
                    ...
                    output_file_name_root=UserKNNCFRecommender.RECOMMENDER_NAME,
                    save_model="best"
                    )
