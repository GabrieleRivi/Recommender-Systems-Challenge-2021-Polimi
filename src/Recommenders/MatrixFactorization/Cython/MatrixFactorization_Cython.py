...
from src.Recommenders.Base.BaseMatrixFactorizationRecommender import BaseMatrixFactorizationRecommender
...
class _MatrixFactorization_Cython(BaseMatrixFactorizationRecommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=300, batch_size = 1000,
        ...
        from .MatrixFactorization_Cython_Epoch import MatrixFactorization_Cython_Epoch
